...
| Observability | Structured logs, Ragas/DeepEval eval stubs, and CI checks |
...
```bash
# Requires: live stack + seeded data (see Demo Quickstart)
python evals/run_eval.py
```

This is a fixed regression suite (5 Calgary cases, not a large benchmark). The `reports/eval_summary.md` file in this repo is a placeholder — run the script against a seeded stack to populate it with real results. See `evals/README.md` for the full assertion list and expected output format.
